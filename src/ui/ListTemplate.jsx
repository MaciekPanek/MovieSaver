...
function ListTemplate({ movieDetails, children }, ref) {
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      <div
        className="w-[65rem] h-[30rem] bg-stone-400 flex p-3 gap-5  rounded-3xl border-b-[3px] border-b-yellow-500"
        ref={ref}
      >
        <img src={movieDetails.Poster} className=" rounded-3xl  " />
        <div className="flex flex-col justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-center py-5 italic text-lg text-stone-700">
              {movieDetails.Plot}
            </span>
